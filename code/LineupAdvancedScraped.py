...
if __name__ == "__main__":
	...
	start = np.linspace(4600, 5500, 10, dtype = int)
	end = np.linspace(4700, 5600, 10, dtype = int)
	freq = list(zip(start, end))

	time_spend_name = "processing_time/TimeSpend_" + str(start[0]) + "_" + str(start[-1]) + ".txt"
